...
#  fpr = np.loadtxt('fpr.txt')
#  tpr = np.loadtxt('tpr.txt')
#  plot_roc(tpr, fpr, 1)
    
    
#  d,d1,d2,l1,l2,rl = rechoose2(GP_test,mu,var,GP_test)
#  mu2,var2 = GPR2(np.float64(np.vstack((d1,d2))),np.float64(np.vstack((l1,l2))),GP_test)
#  np.savetxt('mu2.txt',mu2)
#  np.savetxt('var2.txt',var2)
#  mu2 = np.loadtxt('mu2.txt')
#  var2 = np.loadtxt('var2.txt')
#  a = np.hstack((label,100*np.reshape(mu2,[np.shape(data)[0],1]),np.reshape(var2,[np.shape(data)[0],1])))
#  f1 = []
#  tprm,tnrm = [],[]
#  for j in np.linspace(0,99,100):
#    TPR,TNR,F1 = result_of_method(a,inlier_num,j)
...
#  
#  
#  d,d3,d4,l3,l4,rl = rechoose2(GP_test,mu2,var2,GP_test)
#  mu3,var3 = GPR2(np.float64(np.vstack((d3,d4))),np.float64(np.vstack((l3,l4))),GP_test)
#  np.savetxt('mu3.txt',mu3)
#  np.savetxt('var3.txt',var3)
#  mu3 = np.loadtxt('mu3.txt')
#  var3 = np.loadtxt('var3.txt')
#  a = np.hstack((label,100*np.reshape(mu3,[np.shape(data)[0],1]),np.reshape(var3,[np.shape(data)[0],1])))  
#  f1 = []
#  tprm,tnrm = [],[]
#  for j in np.linspace(0,99,100):
#    TPR,TNR,F1 = result_of_method(a,inlier_num,j)
...
#  print(f1[_],tprm[_],tnrm[_])
#  
#  d,d5,d6,l5,l6,rl = rechoose2(GP_test,mu3,var3,GP_test)
#  mu4,var4 = GPR2(np.float64(np.vstack((d5,d6))),np.float64(np.vstack((l5,l6))),GP_test)
#  np.savetxt('mu4.txt',mu4)
#  np.savetxt('var4.txt',var4)
#  mu4 = np.loadtxt('mu4.txt')
#  var4 = np.loadtxt('var4.txt')
#  a = np.hstack((label,100*np.reshape(mu4,[np.shape(data)[0],1]),np.reshape(var4,[np.shape(data)[0],1])))  
#  f1 = []
#  tprm,tnrm = [],[]
#  for j in np.linspace(0,99,100):
#    TPR,TNR,F1 = result_of_method(a,inlier_num,j)
...
#  
#  
#  d,d7,d8,l7,l8,rl = rechoose2(GP_test,mu4,var4,GP_test)
#  mu5,var5 = GPR2(np.float64(np.vstack((d7,d8))),np.float64(np.vstack((l7,l8))),GP_test)
#  np.savetxt('mu5.txt',mu5)
#  np.savetxt('var5.txt',var5)
#  mu5 = np.loadtxt('mu5.txt')
#  var5 = np.loadtxt('var5.txt')
#  a = np.hstack((label,100*np.reshape(mu5,[np.shape(data)[0],1]),np.reshape(var5,[np.shape(data)[0],1])))  
#  f1 = []
#  tprm,tnrm = [],[]
#  for j in np.linspace(0,99,100):
#    TPR,TNR,F1 = result_of_method(a,inlier_num,j)
...
#  print(f1[_],tprm[_],tnrm[_])
#  
#  d,d9,d10,l9,l10,rl = rechoose2(GP_test,mu5,var5,GP_test)
#  mu6,var6 = GPR2(np.float64(np.vstack((d9,d10))),np.float64(np.vstack((l9,l10))),GP_test)
#  np.savetxt('mu6.txt',mu6)
#  np.savetxt('var6.txt',var6)
#  mu6 = np.loadtxt('mu6.txt')
#  var6 = np.loadtxt('var6.txt')
#  a = np.hstack((label,100*np.reshape(mu6,[np.shape(data)[0],1]),np.reshape(var6,[np.shape(data)[0],1])))  
#  f1 = []
#  tprm,tnrm = [],[]
#  for j in np.linspace(0,99,100):
#    TPR,TNR,F1 = result_of_method(a,inlier_num,j)
...
#  print(f1[_],tprm[_],tnrm[_])
#  
#  d,d11,d12,l11,l12,rl = rechoose2(GP_test,mu6,var6,GP_test)
#  mu7,var7 = GPR2(np.float64(np.vstack((d11,d12))),np.float64(np.vstack((l11,l12))),GP_test)
#  np.savetxt('mu7.txt',mu7)
#  np.savetxt('var7.txt',var7)
#  mu7 = np.loadtxt('mu7.txt')
#  var7 = np.loadtxt('var7.txt')
#  a = np.hstack((label,100*np.reshape(mu7,[np.shape(data)[0],1]),np.reshape(var7,[np.shape(data)[0],1])))  
#  f1 = []
#  tprm,tnrm = [],[]
#  for j in np.linspace(0,99,100):
#    TPR,TNR,F1 = result_of_method(a,inlier_num,j)
...
#  
#  
#  d,d13,d14,l13,l14,rl = rechoose2(GP_test,mu7,var7,GP_test)
#  mu8,var8 = GPR2(np.float64(np.vstack((d13,d14))),np.float64(np.vstack((l13,l14))),GP_test)
#  np.savetxt('mu8.txt',mu8)
#  np.savetxt('var8.txt',var8)
#  mu8 = np.loadtxt('mu8.txt')
#  var8 = np.loadtxt('var8.txt')
#  a = np.hstack((label,100*np.reshape(mu8,[np.shape(data)[0],1]),np.reshape(var8,[np.shape(data)[0],1])))  
#  f1 = []
#  tprm,tnrm = [],[]
#  for j in np.linspace(0,99,100):
#    TPR,TNR,F1 = result_of_method(a,inlier_num,j)
...
#  
#  for k in range(6):
#    d,d13,d14,l13,l14,rl = rechoose2(GP_test,mu8,var8,GP_test)
#    mu8,var8 = GPR2(np.float64(np.vstack((d13,d14))),np.float64(np.vstack((l13,l14))),GP_test)
#    np.savetxt('mu8.txt',mu8)
#    np.savetxt('var8.txt',var8)
#    mu8 = np.loadtxt('mu8.txt')
...
#  
#  print('second method')
#  dd1,dd2,ll1,ll2 = rechoose4(GP_test,mu8,var8,label)
#  mu9,var9 = GPR2(np.float64(np.vstack((dd1,dd2))),np.float64(np.vstack((ll1,ll2))),GP_test)
#  np.savetxt('mu9.txt',mu9)
#  np.savetxt('var9.txt',var9)
#  mu9 = np.loadtxt('mu9.txt')
#  var9 = np.loadtxt('var9.txt')
#  a = np.hstack((label,100*np.reshape(mu9,[np.shape(data)[0],1]),np.reshape(var9,[np.shape(data)[0],1])))
#  f1 = []
#  tprm,tnrm = [],[]
#  for j in np.linspace(0,99,100):
#    TPR,TNR,F1 = result_of_method(a,inlier_num,j)
...
#  
#
#  dd3,dd4,ll3,ll4 = rechoose4(GP_test,mu9,var9,label)
#  mu10,var10 = GPR2(np.float64(np.vstack((dd3,dd4))),np.float64(np.vstack((ll3,ll4))),GP_test)
#  a = np.hstack((label,100*np.reshape(mu10,[np.shape(data)[0],1]),np.reshape(var10,[np.shape(data)[0],1])))
#  f1 = []
#  tprm,tnrm = [],[]
#  for j in np.linspace(0,99,100):
#    TPR,TNR,F1 = result_of_method(a,inlier_num,j)
...
#  a = np.argsort(mu2,axis=None)
#  a2 = label[a]
##  a = np.argsort(mu2,axis=None)
#  a3 = var2[a]
#  a4 = np.hstack((np.reshape(a,[7916,1]),a2,a3))
  
#  p2 = GPC2(d,l,GP_test)
#  reconstruct_data = sess.run(autoencoder_output, feed_dict={autoencoder_input:data})
#  print('ok')
#  
#  print('1')
#  #k-means Clustering
#  kmeans = KMeans(init='random', n_clusters=10, n_init=10).fit(compress_data)
#  print('2')
#  pre_label = kmeans.labels_
#  print('3')
#  
#  #match and plot result
#  cluster_match(label,sess,encode_output,kmeans)
#  PLOT(data,reconstruct_data)
#  
#
#
#  print('ok')
...
#  print('1')
#  #k-means Clustering
#  kmeans = KMeans(init='random', n_clusters=10).fit(compress_data)
#  print('2')
#  pre_label = kmeans.labels_
#  print('3')
...
#  
#  #detection
#  centers_normalized = np.zeros([10,10])
#  for i in range(10):
#    centers_normalized[i,:] = centers[i,:]/np.sqrt(np.sum(np.square(centers[i,:])))
#  test_compress = sess.run(encode_output, feed_dict={autoencoder_input:test_data})
#  distance = np.dot(test_compress,np.transpose(centers_normalized))
#  vi = []
#  for i in range(1426):
#    vi.append(np.max(distance[i,:]))
#  
#  #roc,auc
#  fpr,tpr,thresholds = roc_curve(test_label,vi,pos_label=0)
#  areas = auc(fpr,tpr)
#  print('AUC = ')
#  print(areas)
#  plt.plot(fpr,tpr)
#  #match and plot result
#  cluster_match(test_label,sess,encode_output,kmeans)
#
#  print('over')
